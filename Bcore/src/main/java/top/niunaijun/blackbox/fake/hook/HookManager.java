...
import top.niunaijun.blackbox.fake.service.IKeystoreServiceProxy;
...
import top.niunaijun.blackbox.fake.service.ITextServicesManagerProxy;
...
public class HookManager {
    ...
    public void init() {
        if (BlackBoxCore.get().isBlackProcess() || BlackBoxCore.get().isServerProcess()) {
            ...
            addInjector(new IKeystoreServiceProxy());

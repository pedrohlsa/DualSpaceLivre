...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    private static void replaceLastUserIdWithHost(Object[] args) {
        if (args == null) {
            return;
        }
    ...
    public static class GetPackageInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if ("com.google.android.gms".equals(packageName)
                ...
                try {
                    replaceLastUserIdWithHost(args);
                    PackageInfo systemInfo = (PackageInfo) method.invoke(who, args);
                    if (systemInfo != null) {
                        return systemInfo;
                    }
                } catch (Throwable ignored) {
                    // The Play Store has a minimal fallback below.
                }
            }
    ...
    @ProxyMethod("isInstantApp")
    public static class IsInstantApp extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) {
            // A virtually installed package is a regular installed app. Asking
            // Android's physical PackageManager with the virtual user id (0)
            // from a secondary Android profile throws INTERACT_ACROSS_USERS.
            return false;
        }
    }
            ...
            if ("com.google.android.gms".equals(packageName)
                ...
                try {
                    ...
                    ApplicationInfo systemInfo =
                            (ApplicationInfo) method.invoke(who, args);
                    if (systemInfo != null) {
                        return systemInfo;
                    }
                } catch (Throwable ignored) {
                    // Continue with the virtual package lookup.
                }
            }
    ...
    public static class QueryIntentServices extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (BlackBoxCore.getBPackageManager().getService() != null) {
                resolves = BlackBoxCore.getBPackageManager().getService()
            ...
            // Framework facilities such as Android Keystore intentionally
            // resolve a system service outside the virtual package set.
            replaceLastUserIdWithHost(args);
            return method.invoke(who, args);
        }
    }

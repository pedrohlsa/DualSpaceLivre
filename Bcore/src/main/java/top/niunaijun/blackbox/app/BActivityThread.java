...
public class BActivityThread extends IBActivityThread.Stub {
    ...
    public synchronized void handleBindApplication(String packageName, String processName) {
        ...
        try {
            ...
            if (application == null) {
                Slog.w(TAG, "makeApplication returned null, creating the guest application directly");
                try {
                    String applicationClassName = applicationInfo.className;
                    ...
                    application = AppInstrumentation.get().newApplication(
                            classLoader,
                    ...
                    Slog.e(TAG, "Direct guest application creation failed", e);
                }

...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public String getVirtualAdvertisingId(int userId) {
        return VirtualIdentityManager.get().getAdvertisingId(userId);
    }

    public String getVirtualAppSetId(int userId, String packageName) {
